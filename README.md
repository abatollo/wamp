...
**4.1.** Загрузите архив с последней версией PHP для 64–разрядной Windows: [php-8.3.11-Win32-vs16-x64.zip](https://windows.php.net/downloads/releases/php-8.3.11-Win32-vs16-x64.zip). На всякий случай, проверьте на официальном сайте PHP нет ли версии новее: [https://windows.php.net/download/](https://windows.php.net/download/).
