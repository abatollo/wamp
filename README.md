...
1.2. Установите текстовый редактор кода. Хорошие варианты: [Visual Studio Code](https://code.visualstudio.com/), [Brackets](http://brackets.io/), [Atom](https://atom.io/), [Sublime Text](https://www.sublimetext.com/) и [Notepad++](https://notepad-plus-plus.org/).
