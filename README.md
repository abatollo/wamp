...
А чтобы лучше разобраться в веб-серверах давайте вместе установим, самостоятельно настроим и обновим все три компонента: Apache HTTPD 2.4, MySQL 8.0 и PHP 8.3. А заодно разберемся и с phpMyAdmin 5.2.
...
**4.1.** Загрузите архив с последней версией PHP для 64–разрядной Windows: [php-8.3.13-Win32-vs16-x64.zip](https://windows.php.net/downloads/releases/php-8.3.13-Win32-vs16-x64.zip). На всякий случай, проверьте на официальном сайте PHP нет ли версии новее: [https://windows.php.net/download/](https://windows.php.net/download/).

Обратите внимание, что вам нужна версия Thread Safe, то есть работающая в нескольких потоках, и она должна быть ближе к версии Visual Studio, с помощью которой был скомпилирован Apache, например, VS16. Разрядность должна в точности быть как у Apache, 64-битные версии обозначаются x64, а 32-битные — x86.
